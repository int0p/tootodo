...
<Checkbox custom bind:checked={showSidebar} class="h-full flex-col w-[80px] m-2 pr-2 rounded-lg border-r-2 border-blue-100 ">

    <Button class="mb-2 h-screen" color="alternative" pill={true} on:click={()=>showSidebar=!showSidebar}>
        {#if showSidebar}
