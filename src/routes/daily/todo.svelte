...
<div class="w-[calc(100%-500px)] h-full flex-col float-right top-0 right-0 overflow-y-auto" >
        ...
        <AccordionItem bind:open={items[1]}>
            ...
            {#each Array(25) as _}
                <p class="mb-2 text-gray-500 dark:text-gray-400">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo ab necessitatibus sint explicabo ...</p>
            {/each}
